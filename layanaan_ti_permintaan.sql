...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 19 Jul 2023 pada 12.33
...
--
-- Database: `layanaan_ti_permintaan`
--
...
(8, NULL, 'banyak msalah', 'wPzDQZy6sn91rWFNENlvNAIDGND5phblW90qGKDE', '432534', 'test', NULL, '2023-07-08 15:57:00', '2023-06-13 00:04:00', 2, 'daia', 1, '2023-07-08 08:57:00', '2023-07-13 09:05:24', 'admin@gmail.com'),
...
INSERT INTO `departement` (`id`, `nama_departement`, `deleted`, `saldo`, `created_at`, `updated_at`) VALUES
(1, 'k3', 1, 20000, '2023-07-15 05:15:46', '2023-07-15 05:18:40');
...
--
-- Struktur dari tabel `desc_pembelian`
--

CREATE TABLE `desc_pembelian` (
  `id` bigint(20) NOT NULL,
  `url_pembelian` text DEFAULT NULL,
  `no_inventaris` varchar(100) DEFAULT NULL,
  `status_pembayaran` varchar(100) DEFAULT NULL,
  `harga_beli` varchar(100) DEFAULT NULL,
  `id_desc_permintaan` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `desc_permintaan` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `no_aduan` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL,
  `id_inventaris` int(11) DEFAULT NULL,
  `diagnosa` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `tindakan` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `deskripsi` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `id_status_deskripsi` int(11) DEFAULT NULL,
  `id_status_qc` int(11) DEFAULT NULL,
  ...
  `pembelian_status` int(11) DEFAULT NULL,
  `id_jenis_barang` int(11) DEFAULT NULL,
  `id_status` int(11) DEFAULT 1
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data untuk tabel `desc_permintaan`
--

INSERT INTO `desc_permintaan` (`id`, `no_aduan`, `id_inventaris`, `diagnosa`, `tindakan`, `deskripsi`, `id_status_deskripsi`, `id_status_qc`, `id_status_penyelesaian`, `id_teknisi`, `deleted`, `created_at`, `updated_at`, `stock_status`, `pembelian_status`, `id_jenis_barang`, `id_status`) VALUES
(1, 'bipTpHd', NULL, NULL, NULL, 'test1', NULL, NULL, NULL, NULL, 1, '2023-07-15 12:03:22', '2023-07-15 12:05:56', 0, NULL, 1, 1),
(2, 'DFHrAi0', NULL, NULL, NULL, 'test', NULL, NULL, NULL, NULL, 1, '2023-07-16 00:58:27', '2023-07-16 00:58:27', 0, NULL, 1, 1),
(3, 'DFHrAi0', NULL, NULL, NULL, 'test', NULL, NULL, NULL, NULL, 1, '2023-07-16 00:58:34', '2023-07-16 00:58:34', 0, NULL, 2, 1),
(4, 'fncRPzb', NULL, NULL, NULL, 'test11', NULL, NULL, NULL, NULL, 1, '2023-07-16 07:25:23', '2023-07-16 07:26:09', 0, NULL, 1, 1),
(5, 'fncRPzb', NULL, NULL, NULL, 'test', NULL, NULL, NULL, NULL, 0, '2023-07-16 07:25:37', '2023-07-16 07:25:57', 0, NULL, 2, 1),
(6, 'fncRPzb', NULL, NULL, NULL, 'test11', NULL, NULL, NULL, NULL, 1, '2023-07-16 07:26:16', '2023-07-16 07:26:16', 0, NULL, 1, 1),
(7, '0nWkley', NULL, NULL, NULL, 'msi aqua book', 1, 2, 2, NULL, 1, '2023-07-19 00:11:55', '2023-07-19 02:00:26', 2, NULL, 1, 4),
(8, '0nWkley', NULL, NULL, NULL, 'msi aqua book', NULL, NULL, NULL, NULL, 1, '2023-07-19 00:12:16', '2023-07-19 02:55:41', 1, NULL, 1, 1),
(9, '0nWkley', NULL, NULL, NULL, 'msi aqua book lainnya', 1, 1, 1, NULL, 1, '2023-07-19 00:14:44', '2023-07-19 01:11:16', 0, NULL, 1, 1);
...
CREATE TABLE `permintaan` (
  ...
  `alasan_permintaan` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `permintaan` (`id`, `id_user`, `alasan_permintaan`, `no_aduan`, `no_hp`, `lokasi`, `email_atasan`, `tgl_masuk`, `tgl_keluar`, `id_status`, `nama_pengambil`, `deleted`, `created_at`, `updated_at`, `approve_status`) VALUES
(32, 1002, '545', 'VMopyGM', '4523', '534', 'muhammadfadly.mfd@gmail.com', '2023-07-16 12:39:56', NULL, 1, NULL, 1, '2023-07-16 05:39:56', '2023-07-16 05:48:45', 2),
(33, 1002, 'kebutuhan', 'fncRPzb', '5345', 'lokasi', 'muhammadfadly.mfd@gmail.com', '2023-07-16 14:26:23', NULL, 1, NULL, 1, '2023-07-16 07:26:23', '2023-07-16 07:48:17', 2),
(34, 1003, 'rtwe', '0nWkley', '54', '54', 'muhammadfadly.mfd@gmail.com', '2023-07-19 07:14:47', NULL, 1, NULL, 1, '2023-07-19 00:14:47', '2023-07-19 00:14:47', 1);
...
(15, 'permintaan-tindak-lanjut', 'web', '2023-07-16 03:53:48', '2023-07-16 03:53:48'),
(16, 'permintaan-approve', 'web', '2023-07-16 03:53:58', '2023-07-16 03:53:58'),
(17, 'menu-permintaan', 'web', '2023-07-16 03:55:37', '2023-07-16 03:55:37');
...
(5, 'admin', 'web', '2023-07-15 05:01:39', '2023-07-15 05:01:39'),
(6, 'vp', 'web', '2023-07-16 03:56:03', '2023-07-16 03:56:03');
...
(1, 'Fadli', 'muhammadfadly.mfd@gmail.com', NULL, '$2y$10$GdaUT/MYEsjSe9tiVRdvmOdfujygHvZZIUfauU0u8.vjolDh70H7S', NULL, '2023-07-01 20:50:55', '2023-07-16 02:26:54'),
(2, 'Darien Dach Sr.', 'muhammy.mfd@gmail.com', '2023-07-08 21:34:13', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'Gm4qlCuLKN', '2023-07-08 21:34:13', '2023-07-16 02:26:40'),
...
(1002, 'VP', 'vp@gmail.com', NULL, '$2y$10$Yv8ybzYwJExMBEu0pmvjTeC4XsVi9TmUNoyKLLcDqbZGcqUr.yJPS', NULL, '2023-07-16 04:11:28', '2023-07-16 04:23:44'),
(1003, 'admin', 'admin@gmail.com', NULL, '$2y$10$kAFQg2v79d3yp9o1/ailGeyJtaW.L5Lf76TXVW0A0uuO23z/5lyty', NULL, '2023-07-16 04:16:58', '2023-07-16 04:23:08');
...
--
-- Indeks untuk tabel `desc_pembelian`
--
ALTER TABLE `desc_pembelian`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT untuk tabel `desc_pembelian`
--
ALTER TABLE `desc_pembelian`
